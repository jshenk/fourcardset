        ...
        <div className="grid grid-cols-1 pb-12 border-b gap-x-8 gap-y-10 border-gray-900/10 md:grid-cols-3">
          <div>
            ...
            <p className="mt-1 text-sm leading-6 text-gray-300">
              Please use this contact form for all bookings, media inquires or
              to show the band some love!
            </p>
            ...
            <div className="mt-10">
              <Honeypot />
              {success && (
                <p className="p-4 text-green-700 rounded-md bg-green-50">
                  Thanks for contacting us!
                </p>
              )}
              {error && (
                <p className="p-4 text-red-700 rounded-md bg-red-50">
